...
import {
  View, StyleSheet, KeyboardAvoidingView, Platform, SafeAreaView, Text,
} from "react-native";
...
import { validatePhone, normalizeDigits /* normalizePhone */ } from "../../../utils/phone";
    ...
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <View style={styles.buttonPos}>
          <PhoneSubmit disabled={!valid || loading} onPress={onSubmit} loading={loading} />
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  buttonPos: { position: "absolute", top: ms(659), left: ms(35), right: ms(35) },
  errorText: {
    marginTop: ms(8),
    alignSelf: "flex-end",
    marginRight: ms(10),
